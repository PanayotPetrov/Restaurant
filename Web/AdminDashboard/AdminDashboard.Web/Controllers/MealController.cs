namespace AdminDashboard.Web.Controllers
{
    ...
    public class MealController : Controller
    {
        ...
        public async Task<IActionResult> Create(AddMealInputModel model)
        {
            ...
            var id = await this.mealService.CreateAsync(addMealModel, $"{this.configuration["WebRootPath"]}");
        ...
        public async Task<IActionResult> Edit(EditMealInputModel model)
        {
            ...
            await this.mealService.UpdateAsync(editMealModel, $"{this.configuration["WebRootPath"]}");
